        ...
        <ul>
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 col-12">
                    ...
                    {{Form::label($firstname, $firstname, ['class' => 'form col-md-3 col-sm-3 col-xs-3 col-12 capital_letter'])}}
            ...
            <div class="form-group">
                ...
                <a href="{{in_array($user->roles()->first()->name, ['Client', 'Deliver'])?route('user.index', ['type='.$user->roles()->first()->name]):route('user.index')}}"
